...
if __name__ == '__main__':
    ...
    post = Post(title='Винипух', text='...в голове моей опилки...', user=user1)
    ...
    post = Post(title='Собираю всех персонажей', text='осталось 5', user=user2)
    ...
    post = Post(
        ...
        text='Рейенира Таргариен — персонаж вымышленного мира,'
             ...
             'которая боролась за престол со своим единокровным'
             'братом Эйегоном II в ходе Пляски Драконов.'
             'Жена Дейемона Таргариена',
        user=user7,
    )
    ...
    post = Post(
        ...
        text='Старший брат Визериса и Дейнерис Таргариенов,'
             'муж Элии Мартелл, в браке с которой родились двое детей'
             '— Рейнис и Эйгон. Он также является отцом Джона Сноу'
             'от Лианны Старк, на которой тайно женился после аннулирования'
             'брака с Элией.',
        user=user7,
    )
    ...
    post = Post(
        ...
        text='29-летнюю белокурую наследницу престола теперь играет'
             'Эмма Д Арси, а супругу короля — Оливия Кук. На такое решение'
             'создатели сериала пошли из-за скачка во времени:'
             'по словам сценаристов, им важно было показать,'
             'что за 10 лет героини сильно изменились.',
        user=user7,
    )

    post = Post(title='Кто станет королем после Рейниры?', text='', user=user7)
